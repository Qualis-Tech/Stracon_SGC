...
namespace Pe.Stracon.SGC.Presentacion.Core.Controllers.Contractual
{
    public class FlujoAprobacionController : GenericController
    {
        ...
        {
            //*AMDG: Solo visibilidad de unidad operativas activas
            var unidadOperativa = unidadOperativaService.BuscarUnidadOperativa(new FiltroUnidadOperativa() { Nivel = "03", Indicador = "1" });
            //AMDG*
        ...
        {
            //*AMDG: Solo visibilidad de unidad operativas activas
            var unidadOperativa = unidadOperativaService.BuscarUnidadOperativa(new FiltroUnidadOperativa() { Nivel = "03", Indicador = "1" }).Result;
            //AMDG*
