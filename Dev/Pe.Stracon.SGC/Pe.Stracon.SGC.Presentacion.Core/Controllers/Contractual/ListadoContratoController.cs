...
namespace Pe.Stracon.SGC.Presentacion.Core.Controllers.Contractual
{
    ...
    public class ListadoContratoController : GenericController
    {
        ...
        public JsonResult BuscarPlantillaFlujoAprobacion(PlantillaRequest plantilla, FlujoAprobacionRequest flujoAprobacion, string codigoMoneda, string montoContratoString, string montoAcumuladoString)
        {
            ...
            //*AMDG
            var unidadOperativaf = flujoAprobacion.CodigoUnidadOperativa;

            UnidadOperativaResponse unidadOperativa = new UnidadOperativaResponse();

            unidadOperativa = unidadOperativaService.BuscarUnidadOperativa(new FiltroUnidadOperativa() { CodigoUnidadOperativa = unidadOperativaf }).Result.FirstOrDefault();

            if (unidadOperativa.CodigoMontoMinimoControl == null)
            {
            ...
            {
               if (unidadOperativa.CodigoMontoMinimoControl == "E01")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E01").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E02")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E02").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E03")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E03").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E04")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E04").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E05")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E05").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E06")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E06").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E07")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E07").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E08")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E08").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E09")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E09").FirstOrDefault();

                    decimal valorMontoMinimo = montoMinimo != null ? Decimal.Parse(montoMinimo.Atributo3, numberFormatInfo) : 0;
                    flujoAprobacion.IndicadorAplicaMontoMinimo = (montoContrato + montoAcumladoContratoSeleccionado) >= valorMontoMinimo;
                }
                else if (unidadOperativa.CodigoMontoMinimoControl == "E10")
                {
                    var montoMinimo = politicaService.ListarMontoMinimoControlDinamico().Result.Where(g => g.Atributo4 == codigoMoneda && g.Atributo1 == "E10").FirstOrDefault();
